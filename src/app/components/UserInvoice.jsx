...
const UserInvoice = ({ userId }) => {
  ...
  const invoiceHandler = async () => {
    try {
      const response = await fetch(`https://resortbookingdynamic-jureca2ir-udaykirans-projects-040e3fd3.vercel.app/api/users/${userId}`);
  ...
  const deleteBooking = async (bookingId) => {
    ...
    try {
      const response = await fetch(`https://resortbookingdynamic-jureca2ir-udaykirans-projects-040e3fd3.vercel.app//api/users/${bookingId}`, {
        method: 'DELETE',
      });
